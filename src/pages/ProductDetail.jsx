...
import { ShoppingCart, ArrowLeft, Minus, Plus, Star, ChevronLeft, ChevronRight } from 'lucide-react';
            ...
            <div className="container section">
                ...
                <div className="grid grid-2 detail-container">
                            ...
                            <>
                                ...
                                <button
                                    ...
                                    style={{
                                        ...
                                        background: 'rgba(255,255,255,0.7)', border: 'none', borderRadius: '50%', padding: '0.5rem', cursor: 'pointer'
                                    }}
                                >
                                    <ChevronLeft size={24} />
                                </button>
                    ...
                    <div className="detail-content">
                        ...
                        {item.specs && (
                            <div className="product-specs" style={{ marginTop: '1rem', background: '#f9f9f9', padding: '1rem', borderRadius: '8px' }}>
                                <h4>Specifications</h4>
                                <ul style={{ listStyle: 'none', padding: 0, marginTop: '0.5rem' }}>
                                    {Object.entries(item.specs).map(([key, value]) => (
                                        <li key={key} style={{ display: 'flex', justifyContent: 'space-between', padding: '0.25rem 0', borderBottom: '1px solid #eee' }}>
